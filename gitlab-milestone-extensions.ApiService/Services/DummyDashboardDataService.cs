...
public sealed class DummyDashboardDataService : IDashboardDataService
{
    ...
    public Task<MilestoneDashboardDto?> GetDashboardAsync(int milestoneId, CancellationToken cancellationToken)
    {
        cancellationToken.ThrowIfCancellationRequested();
    ...
    public Task<IReadOnlyList<DashboardIssue>> GetIssuesAsync(int milestoneId, CancellationToken cancellationToken)
    {
        cancellationToken.ThrowIfCancellationRequested();
        return Task.FromResult<IReadOnlyList<DashboardIssue>>(Issues.Where(i => i.MilestoneId == milestoneId).ToList());
    }

    public Task<IReadOnlyList<GanttItemDto>> GetGanttAsync(int milestoneId, CancellationToken cancellationToken)
    {
        cancellationToken.ThrowIfCancellationRequested();
